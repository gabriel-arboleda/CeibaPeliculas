package com.ceiba.peliculas.infraestructura.error;

import com.ceiba.peliculas.dominio.excepcion.*;
...
public class ManejadorError extends ResponseEntityExceptionHandler {
    ...
    public ManejadorError() {
        ...
        CODIGOS_ESTADO.put(ExistenciaPeliculaExcepcion.class.getSimpleName(), HttpStatus.NOT_FOUND.value());
        CODIGOS_ESTADO.put(ExistenciaPersonaExcepcion.class.getSimpleName(), HttpStatus.NOT_FOUND.value());
        CODIGOS_ESTADO.put(ExistenciaPrestamoExcepcion.class.getSimpleName(), HttpStatus.NOT_FOUND.value());
        CODIGOS_ESTADO.put(ValorObligatorioExcepcion.class.getSimpleName(), HttpStatus.NOT_FOUND.value());
